...
TEST_F(FxPredefinedHlsl_test, /*DISABLED_*/Test_Predefined)
{
  ...
  EXPECT_STREQ(
    "Texture2D name1909031230 : register(tindex1909031231); "
  ...
  EXPECT_STREQ(
    "cbuffer cbname1909031235 : register(bindex1909031236) "
    "{ const type1909031234 name1909031235; }", 
    __TO_STR(COVELLITE_DECLARE_CONST_BUFFER(type1909031234, name1909031235, index1909031236)));
