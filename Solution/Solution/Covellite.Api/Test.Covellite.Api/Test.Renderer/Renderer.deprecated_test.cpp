...
#define RendererImpl RendererImpl_deprecated

#include "../Mock/Eq.hpp"
#include "../Mock/RendererImpl.deprecated.hpp"

// Расположение класса Renderer
#include "../../Covellite.Api/Renderer/Renderer.deprecated.cpp"
#include "../../Covellite.Api/Renderer/Renderer.windows.cpp"

#define Renderer_test Renderer_deprecated_test
...
{
protected:
  using Tested_t = ::covellite::api::renderer::Renderer_deprecated;
  ...
  using ITexture_t = ::covellite::api::renderer::IGraphicApi_v1::ITexture;
...
inline bool operator== (
  const IGraphicApi_v1::ITexture::Data & _Left,
  const IGraphicApi_v1::ITexture::Data & _Right)
{
...
inline bool operator== (
  const IGraphicApi_v1::IGeometry::Data & _Left,
  const IGraphicApi_v1::IGeometry::Data & _Right)
{
...
TEST_F(Renderer_test, /*DISABLED_*/Test_Constructor_CreateGraphicApiImpl)
{
  ...
  Tested_t Example{ uT("RendererImplDeprecated"), Data };
}
...
TEST_F(Renderer_test, /*DISABLED_*/Test_Constructor_GraphicApiNameToLog)
{
  ...
  Tested_t Example{ uT("RendererImplDeprecated"), Data_t{} };
}
...
TEST_F(Renderer_test, /*DISABLED_*/Test_RendererGeometry)
{
  ...
  public:
    Tested(void) :
      Tested_t(uT("RendererImplDeprecated"), Data_t{})
    {
...
TEST_F(Renderer_test, /*DISABLED_*/Test_CompiledGeometry)
{
  ...
  ::covellite::api::renderer::IGraphicApi_v1::IGeometry::Data Data;
  Data.pVertices = (::covellite::api::renderer::IGraphicApi_v1::Vertex *)pVertex;
  Data.VerticesCount = 1808251119;
  Data.pIndices = (int *)1808251121;
  Data.IndicesCount = 1808251122;
  Data.pTexture = (::covellite::api::renderer::IGraphicApi_v1::ITexture *)hTexture;
  ...
  EXPECT_CALL(RendererImplProxy, CreateGeometry(RendererId, Data))
    .Times(1)
    .WillOnce(Return((::covellite::api::renderer::IGraphicApi_v1::IGeometry *)hGeometry));
...
TEST_F(Renderer_test, /*DISABLED_*/Test_RendererCompiledGeometry)
{
  ...
  class Geometry :
    ::covellite::api::renderer::IGraphicApi_v1::IGeometry
  {
  public:
...
TEST_F(Renderer_test, /*DISABLED_*/Test_ReleaseCompiledGeometry)
{
  ...
  EXPECT_CALL(RendererImplProxy, DestroyGeometry(RendererId, 
    (::covellite::api::renderer::IGraphicApi_v1::IGeometry *)hGeometry))
    .Times(1);
