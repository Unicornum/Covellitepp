...
*  | Buffer                          | data                     | const [Vertex::Gui] *      | Данные вертексного буфера для отрисовки плоских объектов (\ref Footnote "2")    |
*  | ^                               | ^                        | const [Vertex::Textured] * | Данные вертексного буфера для отрисовки объемных объектов                       |
...
*  | kind                                | Требуется Data (kind)      |
*  |-------------------------------------|----------------------------|
*  | Vertex.Gui (\ref Footnote "4")      | Buffer (\ref Footnote "3") |
*  | Vertex.Textured (\ref Footnote "5") | Buffer (\ref Footnote "3") |
