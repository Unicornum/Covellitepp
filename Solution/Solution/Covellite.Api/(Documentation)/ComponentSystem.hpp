...
*  | Texture                      | content (\ref Footnote "5") | std::vector<uint8_t>                      | Бинарные данные текстуры в формате R8G8B8A8                                                              |
...
*  | Shader                       | content (\ref Footnote "5") | std::vector<uint8_t>                      | Содержимое текстового файла шейдера в бинарном виде                                                      |
...
*  | Buffer                       | content (\ref Footnote "5") | std::vector<[Vertex]>                     | Данные вертексного буфера для отрисовки плоских и объемных объектов (\ref Footnote "2")                  |
*  | ^                            | ^                           | std::vector<int>                          | Данные индексного буфера                                                                                 |
