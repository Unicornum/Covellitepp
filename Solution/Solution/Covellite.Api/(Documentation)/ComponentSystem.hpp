...
*  | kind         | Требуется Data (kind) | Параметры | Тип параметра (значение по умолчанию) | Описание параметра                                                                               |
*  |--------------|-----------------------|-----------|---------------------------------------|--------------------------------------------------------------------------------------------------|
*  | -            | Texture               | scale     | float (1.0f)                          | Масштабирующий коэффициент размеров внеэкранной поверхности относительно размеров окна программы |
...
*  - Во всех вариантах использования у компонента внеэкранной поверхности после
*  создания рендера параметры \b width и \b height будут содержать фактические
*  размеры созданной поверхности.
*  
