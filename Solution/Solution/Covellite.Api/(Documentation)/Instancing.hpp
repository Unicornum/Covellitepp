...
*  в зависимости от возможностей оборудования) одинаковых объектов (одни и те же
*  шейдеры + текстуры + вертексный + индексный буферы) в разных положениях за
*  один вызов отрисовки.
*  
*  Идея заключается в формировании общего набора компонентов одного объекта и
...
*  
*  Если количество отрисовываемых объектов необходимо изменять в процессе
*  рендеринга (только в меньшую сторону), то функция обратного вызова должна
