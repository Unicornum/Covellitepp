...
using ExampleProxy_t = ::mock::covellite::rocket::Initializer::Proxy;
...
::mock::covellite::rocket::Initializer Example(Value1);
...
class Initializer
{
  ...
  using StringTranslatorPtr_t =
    ::std::shared_ptr<::mock::covellite::rocket::IStringTranslator>;
