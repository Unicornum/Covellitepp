...
*  GUI, который должен отрисовывать что-либо перед отрисовкой GUI), класс 
...
*  их при уничтожении объекта класса (в случае необходимости изменения логики
*  работы программы следует удалить существующий объект событий и создать новый,
*  установив ему новые обработчики событий).
*
* \code
