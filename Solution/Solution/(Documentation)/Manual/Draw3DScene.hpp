...
*  - \b Камеры - уникальный для сцены объект, определяющий способ отрисовки сцены.
*  - \b Общих \b объектов, таких как настройки конвеера рендеринга
*  и источники света.
...
*
* \image html ".\Solution\(Documentation)\Manual\Cubes.Components.png"
*  
...
*
* \snippet .\Solution\Example\Example\Basements\Simple3DObject.cpp Shader textured object
