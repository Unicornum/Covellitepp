...
*  Раздел проекта примера использования и ручного тестирования фреймворка.
*/
...
*  
*  Описание [ручного тестирования](\ref ExampleManualTestingPage) фреймворка.
*  
*  Проекты
*  -------
*  
...
* ### Проекты Example/Example.Android
*  
