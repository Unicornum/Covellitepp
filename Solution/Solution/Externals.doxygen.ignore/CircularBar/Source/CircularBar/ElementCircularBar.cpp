...
ElementCircularBar::ElementCircularBar(const Rocket::Core::String& tag) : 
  ElementFormControl(tag),
  gauge_geometry(this), gauge_extent(-1, -1), geometry_dirty(true), value(0.0f)
{
}
...
Core::String ElementCircularBar::GetValue() const
{
	return GetAttribute< Core::String >("value", "0.0");
}

// Sets the current value of the circular bar.
void ElementCircularBar::SetValue(const Core::String & _Value)
{
...
void ElementCircularBar::GenerateGeometry()
{
	...
	filled_angle = progression * Core::Math::ROCKET_PI * 2.0f;
